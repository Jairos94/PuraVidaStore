...
//        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-4FJOI9V;Initial Catalog=PuraVidaStore;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BdgId).HasName("PK__Bodegas__522D12A5C05B9E24");
        ...
        {
            entity.HasKey(e => e.ClmId).HasName("PK__Clientes__FD21CFD262633B57");
        ...
        {
            entity.HasKey(e => e.DtfId).HasName("PK__DetalleF__08270EDE8CA73D82");
        ...
        {
            entity.HasKey(e => e.DppId).HasName("PK__DetalleP__45FE6F5A5B95AA16");
        ...
        {
            entity.HasKey(e => e.EtpId).HasName("PK__EstadoPe__CD1FF58CE2F4B89D");
        ...
        {
            entity.HasKey(e => e.EtfId).HasName("PK__EstatusF__CA83E816FD896176");
        ...
        {
            entity.HasKey(e => e.FtrId).HasName("PK__Factura__2B314E1FAC8B2550");
        ...
        {
            entity.HasKey(e => e.FtrId).HasName("PK__FacturaR__2B314E1F9E95BC6D");
        ...
        {
            entity.HasKey(e => e.FrpId).HasName("PK__FormaPag__C30F48C3D0F890FC");
        ...
        {
            entity.HasKey(e => e.HcmId).HasName("PK__Historia__3B25B7B88B67CA67");
        ...
        {
            entity.HasKey(e => e.HlfId).HasName("PK__Historia__A894EAB3FA0C84A0");
        ...
        {
            entity.HasKey(e => e.HlpId).HasName("PK__Historia__AAE48D2CCA65B817");
        ...
        {
            entity.HasKey(e => e.ImpId).HasName("PK__Impuesto__B6CB82B8CB2EED8F");
        ...
        {
            entity.HasKey(e => e.IpfId).HasName("PK__Impuesto__C85CA5DA53856CA5");
            ...
            entity.HasOne(d => d.IpfIdFactura1).WithMany(p => p.ImpuestosPorFacturas)
                .HasForeignKey(d => d.IpfIdFactura)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.ImpPid).HasName("PK__Impuesto__D0483333CE70EC47");
        ...
        {
            entity.HasKey(e => e.MndId).HasName("PK__Moneda__D2906950B6CC1072");
        ...
        {
            entity.HasKey(e => e.MtmId).HasName("PK__MotivosM__62D5204FDDDB684B");
        ...
        {
            entity.HasKey(e => e.MvmId).HasName("PK__Movimien__D46E0D019408A03C");
        ...
        {
            entity.HasKey(e => e.OtrId).HasName("PK__OtrosCar__91381F330764606D");
        ...
        {
            entity.HasKey(e => e.PreId).HasName("PK__Parametr__7024CEC9278E762D");
        ...
        {
            entity.HasKey(e => e.PrgId).HasName("PK__Parametr__76A0837BA009B4EF");

            entity.HasOne(d => d.PrgIdBodegaNavigation).WithMany(p => p.ParametrosGlobales)
                .HasForeignKey(d => d.PrgIdBodega)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Parametro__PrgId__3A4CA8FD");
        });

        modelBuilder.Entity<Pedido>(entity =>
        {
            entity.HasKey(e => e.PddId).HasName("PK__Pedido__98F0BE939B23AC2E");
        ...
        {
            entity.HasKey(e => e.PsrId).HasName("PK__Persona__4F16F4C820704551");
        ...
        {
            entity.HasKey(e => e.PrdId).HasName("PK__Producto__7168B164BEBE1FED");
        ...
        {
            entity.HasKey(e => e.PvdId).HasName("PK__Proveedo__E82C855394F6F592");
        ...
        {
            entity.HasKey(e => e.RluId).HasName("PK__RolUsiar__812CEDA6BDEDFBD0");
        ...
        {
            entity.HasKey(e => e.TpmId).HasName("PK__TipoMovi__0637E7B0D632FFD5");
        ...
        {
            entity.HasKey(e => e.TppId).HasName("PK__TipoProd__028B0F700C97C218");
        ...
        {
            entity.HasKey(e => e.TrkId).HasName("PK__Trackins__B83DA4B225E46B9D");
        ...
        {
            entity.HasKey(e => e.TraId).HasName("PK__Trackins__E6FDEF5044CA7B84");
        ...
        {
            entity.HasKey(e => e.UecId).HasName("PK__UsuaiosE__2A7A03489AEB950D");
        ...
        {
            entity.HasKey(e => e.UsrId).HasName("PK__Usuarios__6A1E3D4895B8C787");
